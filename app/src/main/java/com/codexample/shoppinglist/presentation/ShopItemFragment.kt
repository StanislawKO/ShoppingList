...
import com.codexample.shoppinglist.databinding.FragmentShopItemBinding
...
//            activity?.onBackPressed()
    ...
    private fun parseParams() {
        ...
        if (!args.containsKey(SCREEN_MODE)) {
            throw Exception("Param screen mode is absent")
        }
        ...
        if (screenMode == MODE_EDIT) {
            if (!args.containsKey(SHOP_ITEM_ID)) {
                throw Exception("Param shop item id is absent")
            }
